 ...
 * 
 * @export
 * @interface WorkoutTypeVO
 */
export interface WorkoutTypeVO {
    /**
     * 
     * @type {string}
     * @memberof WorkoutTypeVO
     */
    type: string;
    /**
     * 
 ...
 * @export
 */
export const WorkoutTypeControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @param {*} [options] Override http request option.
...
/**
 * WorkoutTypeControllerApi - functional programming interface
 * @export
 */
export const WorkoutTypeControllerApiFp = function(configuration?: Configuration) {
    return {
        /**
         * 
         * @param {*} [options] Override http request option.
...
/**
 * WorkoutTypeControllerApi - factory interface
 * @export
 */
export const WorkoutTypeControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * 
         * @param {*} [options] Override http request option.
...
/**
 * WorkoutTypeControllerApi - object-oriented interface
 * @export
 * @class WorkoutTypeControllerApi
 * @extends {BaseAPI}
 */
export class WorkoutTypeControllerApi extends BaseAPI {
    /**
     * 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
