    ...
    return {
        ...
        login: async (userLoginForm: UserLoginForm, options: any = {}): Promise<RequestArgs> => {
            ...
            if (userLoginForm === null || userLoginForm === undefined) {
                throw new RequiredError(
                    "userLoginForm",
                    "Required parameter userLoginForm was null or undefined when calling login.",
                );
            }
            ...
            const needsSerialization =
                typeof userLoginForm !== "string" ||
                localVarRequestOptions.headers["Content-Type"] === "application/json";
            localVarRequestOptions.data = needsSerialization
                ? JSON.stringify(userLoginForm !== undefined ? userLoginForm : {})
                : userLoginForm || "";
        ...
        signUp: async (createUserForm: CreateUserForm, options: any = {}): Promise<RequestArgs> => {
            ...
            if (createUserForm === null || createUserForm === undefined) {
                throw new RequiredError(
                    "createUserForm",
                    "Required parameter createUserForm was null or undefined when calling signUp.",
                );
            }
            ...
            const needsSerialization =
                typeof createUserForm !== "string" ||
                localVarRequestOptions.headers["Content-Type"] === "application/json";
            localVarRequestOptions.data = needsSerialization
                ? JSON.stringify(createUserForm !== undefined ? createUserForm : {})
                : createUserForm || "";
...
export const AuthControllerApiFp = function (configuration?: Configuration) {
    return {
        ...
        async login(
            ...
            options?: any,
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TokenVO>> {
            const localVarAxiosArgs = await AuthControllerApiAxiosParamCreator(configuration).login(
                userLoginForm,
                options,
            );
        ...
        async signUp(
            ...
            const localVarAxiosArgs = await AuthControllerApiAxiosParamCreator(configuration).signUp(
                createUserForm,
                options,
            );
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
...
export const AuthControllerApiFactory = function (
    ...
    return {
        ...
        login(userLoginForm: UserLoginForm, options?: any): AxiosPromise<TokenVO> {
            return AuthControllerApiFp(configuration)
                .login(userLoginForm, options)
    ...
    return {
        ...
        createUser: async (createUserForm: CreateUserForm, options: any = {}): Promise<RequestArgs> => {
            ...
            if (createUserForm === null || createUserForm === undefined) {
                throw new RequiredError(
                    "createUserForm",
                    "Required parameter createUserForm was null or undefined when calling createUser.",
                );
            }
...
export const UserControllerApiFp = function (configuration?: Configuration) {
    return {
        ...
        async createUser(
            ...
            const localVarAxiosArgs = await UserControllerApiAxiosParamCreator(configuration).createUser(
                createUserForm,
                options,
            );
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
...
export const UserControllerApiFactory = function (
    ...
    return {
        ...
        createUser(createUserForm: CreateUserForm, options?: any): AxiosPromise<object> {
            return UserControllerApiFp(configuration)
                .createUser(createUserForm, options)
                .then((request) => request(axios, basePath));
        },
    };
};
    ...
    return {
        ...
        save: async (workoutForm: WorkoutForm, options: any = {}): Promise<RequestArgs> => {
            ...
            if (workoutForm === null || workoutForm === undefined) {
                throw new RequiredError(
                    "workoutForm",
                    "Required parameter workoutForm was null or undefined when calling save.",
                );
            }
            ...
            const needsSerialization =
                typeof workoutForm !== "string" ||
                localVarRequestOptions.headers["Content-Type"] === "application/json";
            localVarRequestOptions.data = needsSerialization
                ? JSON.stringify(workoutForm !== undefined ? workoutForm : {})
                : workoutForm || "";
        ...
        workouts1: async (id: string, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/workouts/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
        ...
        workouts2: async (pageable: Pageable, date: string, options: any = {}): Promise<RequestArgs> => {
            ...
            if (pageable === null || pageable === undefined) {
                throw new RequiredError(
                    "pageable",
                    "Required parameter pageable was null or undefined when calling workouts2.",
                );
            }
            ...
            if (date === null || date === undefined) {
                throw new RequiredError(
                    "date",
                    "Required parameter date was null or undefined when calling workouts2.",
                );
            }
            const localVarPath = `/api/workouts`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const WorkoutsControllerApiFp = function (configuration?: Configuration) {
    return {
        ...
        async save(
            ...
            options?: any,
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WorkoutVO>> {
            const localVarAxiosArgs = await WorkoutsControllerApiAxiosParamCreator(configuration).save(
                workoutForm,
                options,
            );
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        ...
        async workouts1(
            ...
            const localVarAxiosArgs = await WorkoutsControllerApiAxiosParamCreator(configuration).workouts1(
                id,
                options,
            );
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        ...
        async workouts2(
            ...
            date: string,
            options?: any,
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WorkoutVO>>> {
            const localVarAxiosArgs = await WorkoutsControllerApiAxiosParamCreator(configuration).workouts2(
                pageable,
                date,
                options,
            );
 ...
 * @export
 */
export const WorkoutsControllerApiFactory = function (
    configuration?: Configuration,
    basePath?: string,
    axios?: AxiosInstance,
) {
    return {
        ...
        save(workoutForm: WorkoutForm, options?: any): AxiosPromise<WorkoutVO> {
            return WorkoutsControllerApiFp(configuration)
                .save(workoutForm, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        workouts2(pageable: Pageable, date: string, options?: any): AxiosPromise<Array<WorkoutVO>> {
            return WorkoutsControllerApiFp(configuration)
                .workouts2(pageable, date, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class WorkoutsControllerApi extends BaseAPI {
    ...
    public save(workoutForm: WorkoutForm, options?: any) {
        return WorkoutsControllerApiFp(this.configuration)
            .save(workoutForm, options)
            .then((request) => request(this.axios, this.basePath));
    }
